...
(defvar ogrok-list nil "Local variable")
...
(defun ogrok (ident)
  ...
  (when (featurep 'xemacs) (error "Not supported on XEmacs."))
...
(defun ogrok-get-page (url buf unused)
  (shell-command (concat "curl \"" url "\"") buf buf))
