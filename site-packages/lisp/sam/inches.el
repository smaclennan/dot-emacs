...
16ths. With one prefix-arg the fraction is 32ends, and with each
prefix-arg the denominator is doubled.  When non-interactive
returns a list '(feet inches fraction denom)."
  (interactive "p\nnInches: ")
  (let* ((feet (floor (/ inches 12)))
	 (denom (* 16 (lsh 1 (floor (log arg 4)))))
