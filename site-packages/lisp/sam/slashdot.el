  ...
  (save-excursion
	...
	(if hlist
	    (progn
		  ...
		  ;; headings match
;; SAM This doesn't work for the weather - turn it off till we can specify no-cache
		  ;; SAM (unless (equal (car list) (car (car (nth 4 hlist))))
...
(defun slashdot-quote (heading)
  ...
  (let ((case-fold-search t)
	...
	(setq str (string-to-number (match-string 2 heading) 10)))
      (setq heading (replace-match (char-to-string (int-to-char str)) nil nil heading)))
