...
(defvar slashdot-xemacs
  (if (boundp 'running-xemacs) running-xemacs nil)
  "Are we running xemacs?")

(defvar slashdot-sxemacs
  (if (boundp 'running-sxemacs) running-sxemacs nil)
  "Are we running sxemacs?")

(require 'http)
(require 'itimer)
(require 'browse-url)
(unless slashdot-xemacs (require 'extent))
