...
(defvar slashdot-xemacs (featurep 'xemacs)
  "Are we running xemacs?")

(defvar slashdot-dot-dir
  (if (boundp 'dot-dir)
      dot-dir
...
;; GNU Emacs needs this, as does slashdot-do-in-gnu-emacs
(eval-when-compile (require 'cl))

(provide 'slashdot)

(defmacro slashdot-do-in-gnu-emacs (&rest body)
  "Execute BODY if in GNU/Emacs."
  (unless (featurep 'xemacs) `(progn ,@body)))
(put 'slashdot-do-in-gnu-emacs 'lisp-indent-hook 'defun)

(defmacro slashdot-do-in-xemacs (&rest body)
  "Execute BODY if in GNU/Emacs."
  (if (featurep 'xemacs) `(progn ,@body)))
(put 'slashdot-do-in-xemacs 'lisp-indent-hook 'defun)

(slashdot-do-in-gnu-emacs (eval-when-compile (require 'extent)))
