...
(defconst mcs-prompts '("0 Find this C symbol"
...
(defun my-cscope-setup ()
  (unless (boundp 'my-cscope-menu)
    (easy-menu-define my-cscope-menu nil "My Cscope Menu"
		      '("Cscope..."
			[(nth 0 mcs-prompts) (my-cscope 0) t]
			[(nth 1 mcs-prompts) (my-cscope 1) t]
			[(nth 2 mcs-prompts) (my-cscope 2) t]
			[(nth 3 mcs-prompts) (my-cscope 3) t]
			[(nth 4 mcs-prompts) (my-cscope 4) t]
			[(nth 5 mcs-prompts) (my-cscope 5) t]
			[(nth 6 mcs-prompts) (my-cscope 6) t]
			[(nth 7 mcs-prompts) (my-cscope 7) t]
			[(nth 8 mcs-prompts) (my-cscope 8) t]
			[(nth 9 mcs-prompts) (my-cscope 9) t]
			))
