...
(mcs-feature-cond
 (xemacs
  (defalias 'mcs-push-tag-mark 'push-tag-mark))
 (xref-push-marker-stack ;; newer GNU Emacs
  (defun mcs-push-tag-mark () (xref-push-marker-stack)))
 (emacs
  (defun mcs-push-tag-mark () (ring-insert find-tag-marker-ring (point-marker)))))
