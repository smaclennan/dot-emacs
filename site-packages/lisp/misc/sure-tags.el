...
;; SAM 2010:	sed s/tags-table-list/tag-table-alist/
;;		patch to handle file names with spaces (not mine)
;;		add require etags
...
(defvar etags-suffixes '("c" "cpp" "cxx" "h" "cc" "hh" "pl" "pm" "el")
